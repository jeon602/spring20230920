...
//    public String method8(String email) {
//    String processed = email + "processed";
////        이메일을 두번째 요청에 나올 수 있도록 하고 싶다ㅓ
////        쿼리 스트링 '?' 사용
//
//        return "redirect:/main16/sub9?p = " + processed;
////        session을 사용하거나 쿼리스트링을 사용하거나 , redirectAttribute로 쓰거나
//
//
//
//
...
//    }
//    @GetMapping("sub11")
//    public void method11(String name, HttpSession session){
//        Object processedValue = session.getAttribute("processedValue");
//        System.out.println("processedValue = "+ processedValue);
//    }
////    @GetMapping("sub12")
////    public void method12(String address, RequestMapping rttr){
////        String processecd = address + "처리 결과";
////        rttr.addFlashAttribute("processedValue",processecd);
////        return "redirect:/main16/sub13";
////    }
//
//    @GetMapping("sub13")
...
//
////    첫 요청은 서브 14로 보냈을 때
//    @GetMapping("sub14") //꼭 redirect만 써야하는 게 아니라 session  사용도 있음
//    public String method14(RedirectAttributes rttr){
////        /main16/sub15요청 할 때  foolisr라는 속성 값을 꺼낼 수 있도록 코드를 작성하시오
//        rttr.addFlashAttribute("foodList", List.of("송편","만두"));
//        return "redirect:/main16/sub15";
//    }
//
//    @GetMapping("sub15")
